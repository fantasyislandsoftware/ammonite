...
describe(`MOVE_IMM_TO_IWD CONV`, () => {
  ...
  it(`MIN`, () => {
    ...
    ).toEqual('move.l #0x00007fff,0x7fff(a0)');
  });
  it(`MAX`, () => {
    expect(
      MOVE(
    ...
    ).toEqual('move.l #0x7fffffff,0x7fff(a0)');
  });
});

describe('IMM_TO_IWD EXE', () => {
  const cmd = [
    'move.w #0x00005678,0x0002(a0)',
    'move.l #0x12345678,0x0002(a0)',
  ];
  //
  class S {
    public setting = {
