...
describe(`MOVE_IWD_TO_IWD`, () => {
  ...
  it(`MIN`, () => {
    ...
    ).toEqual('move.l 0x0001(a0),0x0001(a0)');
  });
  it(`MAX`, () => {
    expect(
      MOVE(task, [
    ...
    ).toEqual('move.l 0x7fff(a7),0x7fff(a7)');
  });
});

describe('IWD_TO_IWD EXE', () => {
  const cmd = [
    'move.b 0x0004(a0),0x0002(a1)',
    'move.w 0x0004(a0),0x0002(a1)',
    'move.l 0x0004(a0),0x0002(a1)',
  ];
  //
  class S {
    public setting = {
